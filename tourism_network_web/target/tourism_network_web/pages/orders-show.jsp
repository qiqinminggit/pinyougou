		...
		<div class="content-wrapper">
			...
			<div class="panel panel-default">
				...
				<div class="row data-type">
					...
					<div class="col-md-4 data">
						<input type="text" class="form-control" placeholder="客房类型"
							value="${orders.product.roomType }" readonly="readonly">
					</div>

					<div class="col-md-2 title">客房房间号</div>
					<div class="col-md-4 data">
						<input type="text" class="form-control" placeholder="客房房间号"
							value="${orders.product.roomNum }" readonly="readonly">
					</div>
					...
					<div class="col-md-4 data">
						<div class="input-group date">
							...
							<input type="text" class="form-control pull-right" id="dateTimePicker"  value="${orders.orderTimeStr}">
						</div>
					</div>
					<div class="col-md-2 title">入住人数</div>
					<div class="col-md-4 data">
						<input type="text" class="form-control" placeholder="入住人数"
