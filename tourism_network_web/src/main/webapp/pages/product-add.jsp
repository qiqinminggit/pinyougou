			...
			<form action="${pageContext.request.contextPath}/product/save.do"
				...
				<div class="panel panel-default">
					...
					<div class="row data-type">
						...
						<div class="col-md-2 title">客房编号</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="productNum"
								placeholder="客房编号" value="">
						</div>
						...
						<div class="col-md-2 title">客户证件</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="productName"
								   placeholder="客户证件" value="">
						</div>
						<div class="col-md-2 title">客房房号</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="productName"
								   placeholder="客房房号" value="">
						</div>
						...
						<div class="col-md-4 data">
							<select class="form-control select2" style="width: 100%"
								name="productStatus">
								<option value="0" selected="selected">已满</option>
