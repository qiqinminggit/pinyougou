								...
								<div class="form-group form-inline">
									<div class="btn-group">
										...
										<button type="button" class="btn btn-default" title="删除"
												onclick="location.href='${pageContext.request.contextPath}/orders/delete.do?id=${orders.id}'">
							...
							<table id="dataList"
								...
								<thead>
									<tr>
										...
										<th class="sorting_productId">房间号</th>
										<th class="sorting_asc sorting_asc_disabled">客房类型</th>
								...
								<tbody>
									...
									<c:forEach items="${pageInfo.list}" var="orders">
										...
										<tr>
											...
											<td>${orders.product.roomNum }</td>
											<td>${orders.product.roomType }</td>
