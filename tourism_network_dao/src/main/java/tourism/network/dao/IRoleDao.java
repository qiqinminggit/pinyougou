...
public interface IRoleDao {
    ...
    @Results({
            ...
            @Result(property = "permissions",column = "id",javaType = java.util.List.class,many = @Many(select = "tourism.network.dao.IPermissionDao.findPermissionByRoleId"))
    })
    ...
    void deleteRoelByRoleId(String roleId);
}